...
import { ChainId, Currency, NATIVE, Percent, WNATIVE, WNATIVE_ADDRESS } from '@dogmoneyswap/sdk'
  ...
  */
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | DOGMONEY</title>
        <meta key="description" name="description" content="Remove liquidity from the DOGMONEY AMM" />
      </Head>
                        ...
                        {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                          <RowBetween className="text-sm">
                            {oneCurrencyIsETH ? (
                              ...
                              <Link
                                href={`/remove/${currencyA?.equals(WNATIVE[chainId]) ? 'DOGE' : currencyIdA}/${
                                  currencyB?.equals(WNATIVE[chainId]) ? 'DOGE' : currencyIdB
                                }`}
                              >
