    ...
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        ...
        <meta
          key="description"
          name="description"
          content="Stake MIST in return for xMIST, an interest bearing and fungible SEP20 token designed to share revenue generated by all MIST products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.mistswap.fi/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE MIST" />
        <meta
        ...
        <meta key="og:title" property="og:title" content="STAKE MIST" />
        <meta key="og:url" property="og:url" content="https://app.mistswap.fi/stake" />
