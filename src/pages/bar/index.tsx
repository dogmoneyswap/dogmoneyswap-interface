...
export default function Stake() {
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Stake | DOGMONEY</title>
        <meta
          key="description"
          name="description"
          content="Stake DOGMONEY in return for xDOGMONEY, an interest bearing and fungible ERC-20 token designed to share revenue generated by all DOGMONEY products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.dogmoney.money/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE DOGMONEY" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="Stake DOGMONEY in return for xDOGMONEY, an interest bearing and fungible ERC-20 token designed to share revenue generated by all DOGMONEY products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.dogmoney.money/xmist-sign.png" />
        <meta key="og:title" property="og:title" content="STAKE DOGMONEY" />
        <meta key="og:url" property="og:url" content="https://app.dogmoney.money/stake" />
        <meta key="og:image" property="og:image" content="https://app.dogmoney.money/xmist-sign.png" />
        <meta
          key="og:description"
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Maximize yield by staking DOGMONEY for xDOGMONEY`)}
              </div>
            ...
            <div
              className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0"
            ...
            >
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as DOGMONEY
                                ...
                                xDOGMONEY in return.
                                Your xDOGMONEY is continuously compounding, when you unstake you will receive all the originally deposited
                                DOGMONEY and any additional from fees.`)}
            </div>
            {/* <div className="flex">
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex space-x-2 ">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}DOGMONEY`}
                      </p>
                    </div>
                ...
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    <Image
                      ...
                      src="/images/tokens/xdogmoney-square.jpg"
                      alt="xDOGMONEY"
                      width={64}
                      height={64}
                    />
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">xDOGMONEY</p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">DOGMONEY</p>
                    </div>
                  </div>
                </div>
                  ...
                  {account && (
                    <a
                      ...
                      className={`
                            ...
                            `}
                    >
                      {i18n._(t`Your DOGMONEYBowl Stats`)}
                    </a>
                  )}
                </div>
                */}
